...
- Current Asset Library upload/registration is separated from the deprecated media API, and asset
  version, eligibility, moderation and delivery states are not conflated.
- Reporting and Marketing Stream availability includes history, beta, AWS subscription and raw
  ingestion caveats.
